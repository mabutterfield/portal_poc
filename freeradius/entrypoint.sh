...
sed -i "s|%%SHARED_SECRET%%|${SECRET}|g"  /etc/freeradius/3.0/clients.conf
sed -i "s|%%FORTIGATE_IP%%|${FGT_IP}|g"   /etc/freeradius/3.0/clients.conf
sed -i "s|%%SHARED_SECRET%%|${SECRET}|g"  /etc/freeradius/3.0/mods-config/files/authorize
